...
def evaluate():
    ...
    1. Accuracy (0-100): Is the response factually correct and aligned with industry best practices? Consider the context of the question and potential for multiple valid perspectives. (Weight: 25%)
    ...
    2. Completeness (0-100): Does the response address all essential aspects of the question, including relevant details and nuances? Balance conciseness with comprehensiveness. (Weight: 20%)
    ...
    3. Relevance (0-100): Is the response focused on the question asked, avoiding unnecessary digressions or irrelevant information? Does it demonstrate understanding of the role's requirements? (Weight: 15%)
    ...
    4. Clarity (0-100): Is the response clear, concise, and easy to understand? Does the candidate use appropriate language for a professional setting and avoid ambiguity? (Weight: 15%)
    ...
    5. Depth (0-100): Does the response demonstrate a deep understanding of the topic, or is it superficial? Consider the complexity of the question and its potential for insightful analysis. (Weight: 10%)
    ...
    6. Organization (0-100): Is the response well-organized and structured? Does it flow logically with clear transitions, if applicable? Does it demonstrate effective communication skills? (Weight: 5%)
    ...
    7. Use of Evidence (0-100): Does the response provide evidence (e.g., statistics, research findings, industry case studies, personal experiences) to substantiate its claims? Consider the nature of the question and whether evidence is necessary.
       ...
       - For Opinion-Based Answers: Evidence can add weight but isn't always mandatory. (Weight: 5%)
    ...
    8. Grammar and Spelling (0-100): Evaluate the response for grammatical accuracy and spelling errors. Is it free from grammatical mistakes and typos? (Weight: 5%)
    ...
    9. Sentiment (0-100): What is the overall tone and emotion conveyed in the response? (Weight: 5%)
